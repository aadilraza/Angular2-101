...
var WFACalculatorComponent = (function () {
    function WFACalculatorComponent() {
        ...
        this.saveResult = function () {
            var add = parseInt(_this.data.a1.toString()) + parseInt(_this.data.a2.toString());
            var mult = parseInt(_this.data.a3.toString()) * parseInt(_this.data.a4.toString());
            _this.result.emit({ additionResult: add, multiplicationResult: mult });
        };
    }
    __decorate([
        core_1.Input(), 
